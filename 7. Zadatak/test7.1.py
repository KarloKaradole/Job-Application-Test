...
INSERT INTO authors (name,books,age) values ("Mia",40,25); INSERT INTO authors (name,books,age) values("Neo", 35,35);
INSERT INTO authors (name,books,age) values("Neo", 35,35);

Expected output (in any order): name, , Neo,Nolan.

Explanation: In this example, Neo has has published more tha 30 books, while Nolan is under 30 years old. Both names start with letter "N".
...
This query will return the names "Neo" and "Nolan" based on the example case provided.
